module Compiler.Generate.Rust.Name exposing
    ( Name
    , dollar
    , fromCycle
    , fromGlobal
...
reservedNames =
    EverySet.union rustReservedWords guidaReservedWords


rustReservedWords : EverySet String String
rustReservedWords =
...
allBadFields =
    ...
    in
    Dict.values compare (EverySet.foldr compare add Dict.empty rustReservedWords)
