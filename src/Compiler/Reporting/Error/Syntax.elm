...
patternCodec =
    Serialize.customType
        (\pRecordCodecEncoder pTupleCodecEncoder pListCodecEncoder pStartEncoder pCharEncoder pStringEncoder pNumberEncoder pFloatEncoder pAliasEncoder pWildcardNotVarEncoder pWildcardReservedWordEncoder pSpaceEncoder pIndentStartEncoder pIndentAliasEncoder value ->
            case value of
                PRecord record row col ->
                ...
                PWildcardReservedWord name width row col ->
                    pWildcardReservedWordEncoder name width row col
        ...
        |> Serialize.variant4 PWildcardReservedWord Serialize.string Serialize.int Serialize.int Serialize.int
