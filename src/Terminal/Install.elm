...
type Changes vsn
    ...
    | Changes (Dict ( String, String ) T.CEP_Name (Change vsn)) Outline.Outline
                ...
                case Registry.getVersions_ pkg registry of
                    ...
                    Ok (Registry.KnownVersions _ _) ->
                        let
                            ...
                            cons : Dict ( String, String ) T.CEP_Name C.Constraint
                            cons =
                                    ...
                                    case result of
                                        Solver.SolverOk solution ->
                                            let
                                                ...
                                                new : Dict ( String, String ) T.CEP_Name C.Constraint
                                                new =
                                                    Dict.insert identity pkg con old

                                                changes : Dict ( String, String ) T.CEP_Name (Change C.Constraint)
                                                changes =
                                                    detectChanges old new

                                                news : Dict ( String, String ) T.CEP_Name C.Constraint
                                                news =
...
addNews : Maybe T.CEP_Name -> Dict ( String, String ) T.CEP_Name C.Constraint -> Dict ( String, String ) T.CEP_Name C.Constraint -> Dict ( String, String ) T.CEP_Name C.Constraint
addNews pkg new old =
    Dict.merge compare
...
detectChanges : Dict ( String, String ) T.CEP_Name a -> Dict ( String, String ) T.CEP_Name a -> Dict ( String, String ) T.CEP_Name (Change a)
detectChanges old new =
    Dict.merge compare
...
addChange : (a -> String) -> Widths -> T.CEP_Name -> Change a -> ChangeDocs -> ChangeDocs
...
widen : (a -> String) -> T.CEP_Name -> Change a -> Widths -> Widths
