    ...
    let
        ...
        makeFlags =
            Terminal.flags
                ...
                |> Terminal.more (Terminal.onOff "no-warnings" "Suppress all warnings.")
                |> Terminal.more (Terminal.onOff "deny-warnings" "Treat warnings as errors. If set, the build will fail if there are any warnings.")
        ...
        \chunks ->
            Chomp.chomp Nothing
                ...
                (Chomp.pure Make.Flags
                    ...
                    |> Chomp.apply (Chomp.chompOnOffFlag "no-warnings")
                    |> Chomp.apply (Chomp.chompOnOffFlag "deny-warnings")
