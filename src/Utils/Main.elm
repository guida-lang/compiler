...
lockFile path _ s =
    ( s, T.LockFile IO.pure path )


unlockFile : T.FilePath -> IO ()
unlockFile path _ s =
    ( s, T.UnlockFile IO.pure path )
...
dirDoesFileExist filename _ s =
    ( s, T.DirDoesFileExist IO.pure filename )


dirFindExecutable : T.FilePath -> IO (Maybe T.FilePath)
dirFindExecutable filename _ s =
    ( s, T.DirFindExecutable IO.pure filename )


dirCreateDirectoryIfMissing : Bool -> T.FilePath -> IO ()
dirCreateDirectoryIfMissing createParents filename _ s =
    ( s, T.DirCreateDirectoryIfMissing IO.pure createParents filename )


dirGetCurrentDirectory : IO String
dirGetCurrentDirectory _ s =
    ( s, T.Pure s.currentDirectory )


dirGetAppUserDataDirectory : T.FilePath -> IO T.FilePath
dirGetAppUserDataDirectory filename _ s =
    ( s, T.Pure (s.homedir ++ "/." ++ filename) )


dirGetModificationTime : T.FilePath -> IO Time.Posix
dirGetModificationTime filename =
    (\_ s -> ( s, T.DirGetModificationTime IO.pure filename ))
        |> IO.fmap Time.millisToPosix


dirRemoveFile : T.FilePath -> IO ()
dirRemoveFile path _ s =
    ( s, T.DirRemoveFile IO.pure path )


dirRemoveDirectoryRecursive : T.FilePath -> IO ()
dirRemoveDirectoryRecursive path _ s =
    ( s, T.DirRemoveDirectoryRecursive IO.pure path )


dirDoesDirectoryExist : T.FilePath -> IO Bool
dirDoesDirectoryExist path _ s =
    ( s, T.DirDoesDirectoryExist IO.pure path )


dirCanonicalizePath : T.FilePath -> IO T.FilePath
dirCanonicalizePath path _ s =
    ( s, T.DirCanonicalizePath IO.pure path )
...
dirWithCurrentDirectory dir action =
    dirGetCurrentDirectory
        |> IO.bind
            (\currentDir ->
                bracket_
                    (\_ s -> ( s, T.DirWithCurrentDirectory IO.pure dir ))
                    (\_ s -> ( s, T.DirWithCurrentDirectory IO.pure currentDir ))
                    action
            )
...
envLookupEnv name _ s =
    ( s, T.Pure (Dict.get name s.envVars) )
...
forkIO ioArg _ s =
    ( s, T.ForkIO (\() -> IO.pure ThreadId) ioArg )
...
readMVar_Result_BuildProjectProblem_RootInfo (T.MVar_Result_BuildProjectProblem_RootInfo ref) index s =
...
readMVar_Manager (T.MVar_Manager ref) index s =
...
readMVar_BB_ResultDict (T.MVar_BB_ResultDict ref) index s =
...
readMVar_ChItem_Maybe_DMsg (T.MVar_ChItem_Maybe_DMsg ref) index s =
...
readMVar_ChItemResultBMsgBResultDocumentation (T.MVar_ChItemResultBMsgBResultDocumentation ref) index s =
...
readMVar_ChItemResultBMsgBResultUnit (T.MVar_ChItemResultBMsgBResultUnit ref) index s =
...
readMVar_ChItemResultBMsgBResultArtifacts (T.MVar_ChItemResultBMsgBResultArtifacts ref) index s =
...
takeMVar_Stream_Maybe_DMsg (T.MVar_Stream_Maybe_DMsg ref) _ s =
...
takeMVar_StreamResultBMsgBResultDocumentation (T.MVar_StreamResultBMsgBResultDocumentation ref) _ s =
...
takeMVar_StreamResultBMsgBResultUnit (T.MVar_StreamResultBMsgBResultUnit ref) _ s =
...
takeMVar_StreamResultBMsgBResultArtifacts (T.MVar_StreamResultBMsgBResultArtifacts ref) _ s =
...
putMVar_Manager (T.MVar_Manager ref) value _ s =
    case Array.get ref s.mVars_Manager of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_BB_ResultDict (T.MVar_BB_ResultDict ref) value _ s =
    case Array.get ref s.mVars_BB_ResultDict of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_Stream_Maybe_DMsg (T.MVar_Stream_Maybe_DMsg ref) value index s =
    case Array.get ref s.mVars_Stream_Maybe_DMsg of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_ChItem_Maybe_DMsg (T.MVar_ChItem_Maybe_DMsg ref) value _ s =
    case Array.get ref s.mVars_ChItem_Maybe_DMsg of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_StreamResultBMsgBResultDocumentation (T.MVar_StreamResultBMsgBResultDocumentation ref) value index s =
    case Array.get ref s.mVars_StreamResultBMsgBResultDocumentation of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_ChItemResultBMsgBResultDocumentation (T.MVar_ChItemResultBMsgBResultDocumentation ref) value _ s =
    case Array.get ref s.mVars_ChItemResultBMsgBResultDocumentation of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_StreamResultBMsgBResultUnit (T.MVar_StreamResultBMsgBResultUnit ref) value index s =
    case Array.get ref s.mVars_StreamResultBMsgBResultUnit of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_ChItemResultBMsgBResultUnit (T.MVar_ChItemResultBMsgBResultUnit ref) value _ s =
    case Array.get ref s.mVars_ChItemResultBMsgBResultUnit of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_StreamResultBMsgBResultArtifacts (T.MVar_StreamResultBMsgBResultArtifacts ref) value index s =
    case Array.get ref s.mVars_StreamResultBMsgBResultArtifacts of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_ChItemResultBMsgBResultArtifacts (T.MVar_ChItemResultBMsgBResultArtifacts ref) value _ s =
    case Array.get ref s.mVars_ChItemResultBMsgBResultArtifacts of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_BED_Status (T.MVar_Maybe_BED_Status ref) index s =
...
putMVar_Maybe_BED_Status (T.MVar_Maybe_BED_Status ref) value _ s =
    case Array.get ref s.mVars_Maybe_BED_Status of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_BED_DResult (T.MVar_Maybe_BED_DResult ref) index s =
...
putMVar_Maybe_BED_DResult (T.MVar_Maybe_BED_DResult ref) value _ s =
    case Array.get ref s.mVars_Maybe_BED_DResult of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_CASTO_LocalGraph (T.MVar_Maybe_CASTO_LocalGraph ref) index s =
...
putMVar_Maybe_CASTO_LocalGraph (T.MVar_Maybe_CASTO_LocalGraph ref) value _ s =
    case Array.get ref s.mVars_Maybe_CASTO_LocalGraph of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_CASTO_GlobalGraph (T.MVar_Maybe_CASTO_GlobalGraph ref) index s =
...
putMVar_Maybe_CASTO_GlobalGraph (T.MVar_Maybe_CASTO_GlobalGraph ref) value _ s =
    case Array.get ref s.mVars_Maybe_CASTO_GlobalGraph of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_MaybeDep (T.MVar_MaybeDep ref) index s =
...
readMVar_BB_RootResult (T.MVar_BB_RootResult ref) index s =
...
readMVar_BB_RootStatus (T.MVar_BB_RootStatus ref) index s =
...
readMVar_BB_BResult (T.MVar_BB_BResult ref) index s =
...
putMVar_Result_BuildProjectProblem_RootInfo (T.MVar_Result_BuildProjectProblem_RootInfo ref) value _ s =
    case Array.get ref s.mVars_Result_BuildProjectProblem_RootInfo of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_MaybeDep (T.MVar_MaybeDep ref) value _ s =
    case Array.get ref s.mVars_MaybeDep of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_BB_RootResult (T.MVar_BB_RootResult ref) value _ s =
    case Array.get ref s.mVars_BB_RootResult of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_BB_RootStatus (T.MVar_BB_RootStatus ref) value _ s =
    case Array.get ref s.mVars_BB_RootStatus of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
putMVar_BB_BResult (T.MVar_BB_BResult ref) value _ s =
    case Array.get ref s.mVars_BB_BResult of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_BB_Status (T.MVar_BB_Status ref) index s =
...
putMVar_BB_Status (T.MVar_BB_Status ref) value _ s =
    case Array.get ref s.mVars_BB_Status of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_BB_StatusDict (T.MVar_BB_StatusDict ref) index s =
...
takeMVar_BB_StatusDict (T.MVar_BB_StatusDict ref) _ s =
    case Array.get ref s.mVars_BB_StatusDict of
        Just mVar ->
            case mVar.value of
                Just value ->
...
putMVar_BB_StatusDict (T.MVar_BB_StatusDict ref) value index s =
    case Array.get ref s.mVars_BB_StatusDict of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_ResultRegistryProblemEnv (T.MVar_ResultRegistryProblemEnv ref) index s =
...
putMVar_ResultRegistryProblemEnv (T.MVar_ResultRegistryProblemEnv ref) value _ s =
    case Array.get ref s.mVars_ResultRegistryProblemEnv of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_CED_Dep (T.MVar_CED_Dep ref) index s =
...
putMVar_CED_Dep (T.MVar_CED_Dep ref) value _ s =
    case Array.get ref s.mVars_CED_Dep of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_CECTE_Types (T.MVar_Maybe_CECTE_Types ref) index s =
...
putMVar_Maybe_CECTE_Types (T.MVar_Maybe_CECTE_Types ref) value _ s =
    case Array.get ref s.mVars_Maybe_CECTE_Types of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Maybe_BB_Dependencies (T.MVar_Maybe_BB_Dependencies ref) index s =
...
putMVar_Maybe_BB_Dependencies (T.MVar_Maybe_BB_Dependencies ref) value _ s =
    case Array.get ref s.mVars_Maybe_BB_Dependencies of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_DictNameMVarDep (T.MVar_DictNameMVarDep ref) index s =
...
putMVar_DictNameMVarDep (T.MVar_DictNameMVarDep ref) value _ s =
    case Array.get ref s.mVars_DictNameMVarDep of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_DictRawMVarMaybeDResult (T.MVar_DictRawMVarMaybeDResult ref) index s =
...
putMVar_DictRawMVarMaybeDResult (T.MVar_DictRawMVarMaybeDResult ref) value _ s =
    case Array.get ref s.mVars_DictRawMVarMaybeDResult of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
takeMVar_ListMVar (T.MVar_ListMVar ref) _ s =
...
putMVar_ListMVar (T.MVar_ListMVar ref) value index s =
    case Array.get ref s.mVars_ListMVar of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_BB_CachedInterface (T.MVar_BB_CachedInterface ref) index s =
...
takeMVar_BB_CachedInterface (T.MVar_BB_CachedInterface ref) _ s =
    case Array.get ref s.mVars_BB_CachedInterface of
        Just mVar ->
            case mVar.value of
                Just value ->
...
putMVar_BB_CachedInterface (T.MVar_BB_CachedInterface ref) value index s =
    case Array.get ref s.mVars_BB_CachedInterface of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_BED_StatusDict (T.MVar_BED_StatusDict ref) index s =
...
takeMVar_BED_StatusDict (T.MVar_BED_StatusDict ref) _ s =
    case Array.get ref s.mVars_BED_StatusDict of
        Just mVar ->
            case mVar.value of
                Just value ->
...
putMVar_BED_StatusDict (T.MVar_BED_StatusDict ref) value index s =
    case Array.get ref s.mVars_BED_StatusDict of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
readMVar_Unit (T.MVar_Unit ref) index s =
...
takeMVar_Unit (T.MVar_Unit ref) _ s =
    case Array.get ref s.mVars_Unit of
        Just mVar ->
            case mVar.value of
                Just value ->
...
putMVar_Unit (T.MVar_Unit ref) value index s =
    case Array.get ref s.mVars_Unit of
        Just mVar ->
            case mVar.value of
                Just _ ->
...
builderHPutBuilder handle str _ s =
    ( s, T.HPutStr IO.pure handle str )
...
binaryDecodeFileOrFail decoder filename =
    (\_ s -> ( s, T.BinaryDecodeFileOrFail IO.pure filename ))
        |> IO.fmap
...
binaryEncodeFile encoder path value _ s =
    ( s, T.Write IO.pure path (encoder value) )
...
replGetInputLine prompt _ s =
    ( s, T.ReplGetInputLine IO.pure prompt )


replGetInputLineWithInitial : String -> ( String, String ) -> ReplInputT (Maybe String)
replGetInputLineWithInitial prompt ( left, right ) _ s =
    ( s, T.ReplGetInputLineWithInitial IO.pure prompt left right )
