...
const runGuida = function (args) {
    return new Promise(async (resolve) => {
        ...
        server.post("envGetArgs", (request) => {
            console.error("envGetArgs", request);
    ...
    init: async () => {
        ...
        return {
            ...
            format: async (content) => {
                return await runGuida({ command: "format", content });
            },
            install: async (pkg) => {
                return await runGuida({ command: "install", pkg });
            },
            uninstall: async (pkg) => {
                return await runGuida({ command: "uninstall", pkg });
            }
        };
    }
};