...
-}`
    , imports: [
        ...
        "{-| update comments -}",
        "updateFn {- update1 -} : {- update2 -} Int {- update3 -}",
        "updateFn {- update4 -} = {- update5 -} { {- update6 -} a {- update7 -} | {- update8 -} b {- update9 -} = {- update10 -} 1 {- update11 -} } {- update12 -}",
        "{-| record comments -}",
        "recordFn {- record1 -} : {- record2 -} { {- record3 -} a {- record4 -} : {- record5 -} Int {- record6 -} } {- record7 -}",
        "recordFn {- record8 -} = {- record9 -} { {- record10 -} a {- record11 -} = {- record12 -} 1 {- record13 -} } {- record14 -}",
        "{-| unit comment -}",
