...
describe("guida uninstall command", () => {
    it("uninstalls elm package on application elm.json", () => {
    ...
    it("uninstalls elm package on package elm.json", () => {
        const tmpobj = tmp.dirSync();
    ...
    it("uninstalls elm package on application guida.json", () => {
        const tmpobj = tmp.dirSync();
    ...
    it("uninstalls elm package on package guida.json", () => {
        const tmpobj = tmp.dirSync();
    ...
    it("uninstalls guida package on application guida.json", () => {
        const tmpobj = tmp.dirSync();
    ...
    it("uninstalls guida package on package guida.json", () => {
        const tmpobj = tmp.dirSync();
